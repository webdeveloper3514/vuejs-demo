<template>
  <div class="justify-center md:flex md:space-x-2 pt-5 px-3 mx-auto max-w-2xl">
    <h1
      class="text-lg font-bold mx-auto mt-1 p-1 justify-center items-center flex w-full text-center"
    >
      Unauthorized
    </h1>
    <div
    ...
    >
      ...
      >
        ...
        <g id="6c975d28-8d47-4ade-9154-b3b78f637b65" data-name="buttons">
          <circle cx="136.57" cy="121.82" fill="#fff" r="6.5" />
          <circle cx="154.07" cy="121.82" fill="#fff" r="6.5" />
          <circle cx="171.57" cy="121.82" fill="#fff" r="6.5" />
        </g>
        <rect
          fill="#343450"
          height="21.58"
        ...
        <path
          ...
          transform="translate(-26.97 -40.04)"
        />
        <circle cx="924.25" cy="469.12" fill="#3f3d56" r="4.59" />
        <circle cx="924.25" cy="490.76" fill="#3f3d56" r="4.59" />
        <circle cx="924.25" cy="469.12" opacity="0.1" r="4.59" />
        <circle cx="924.25" cy="490.76" opacity="0.1" r="4.59" />
        <path
